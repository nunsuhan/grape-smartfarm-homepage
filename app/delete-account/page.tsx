        ...
        <>
            ...
            <main className="min-h-screen bg-neutral-black text-neutral-cream pt-20 font-sans">
                <Container className="max-w-5xl py-12">
                    <div className="bg-white/5 rounded-lg shadow-sm p-8 md:p-10">
                        <h1 className="text-2xl font-bold text-[#2C5530] mb-2 pb-4 border-b-4 border-[#2C5530]">
                            🗑️ 계정 및 데이터 삭제 요청
                        </h1>
                        <p className="text-neutral-cream/70 text-sm mb-8">
                            FarmSense 계정 삭제 및 개인정보 삭제 요청
                        </p>

                        <div className="bg-green-500/10 border-l-4 border-green-500 p-4 rounded mb-6">
                        ...
                        <p className="text-neutral-cream/70 mb-2">계정 삭제 시 다음 데이터가 영구적으로 삭제됩니다:</p>
                        <ul className="list-disc pl-6 space-y-1 text-neutral-cream/70 mb-6">
                        ...
                        <form action="mailto:artmer3061@gmail.com" method="post" encType="text/plain" className="space-y-5">
                            <div>
                                <label htmlFor="email" className="block font-semibold text-white/90 mb-1">가입 이메일 주소 *</label>
                                <input
                                    type="email"
                                    id="email"
                                    name="email"
                                    ...
                                    className="w-full px-3 py-3 border border-white/15 rounded-md focus:outline-none focus:border-[#2C5530]"
                                />
                            </div>
                            <div>
                                <label htmlFor="name" className="block font-semibold text-white/90 mb-1">이름 *</label>
                                <input
                                    type="text"
                                    id="name"
                                    name="name"
                            ...
                            <div>
                                <label htmlFor="reason" className="block font-semibold text-white/90 mb-1">삭제 사유 (선택)</label>
                                <select
                                    id="reason"
                                    name="reason"
                                    className="w-full px-3 py-3 border border-white/15 rounded-md focus:outline-none focus:border-[#2C5530]"
                            ...
                            <div>
                                <label htmlFor="message" className="block font-semibold text-white/90 mb-1">추가 요청사항 (선택)</label>
                                <textarea
                                    id="message"
                                    name="message"
                                    placeholder="추가로 전달할 내용이 있으면 입력해주세요."
                                    rows={4}
                                    className="w-full px-3 py-3 border border-white/15 rounded-md focus:outline-none focus:border-[#2C5530] resize-y"
                                />
                            </div>
                            <div className="flex items-start gap-3">
                                <input
                                    ...
                                    name="confirm"
                                    required
                                    className="mt-1 w-4 h-4 rounded border-white/15 text-[#2C5530] focus:ring-[#2C5530]"
                                />
                                <label htmlFor="confirm" className="text-sm text-neutral-cream/70">
                        ...
                        <div className="bg-white/10 p-5 rounded-lg">
                            ...
                            <p className="text-neutral-cream/70">삭제 요청 관련 문의: <strong>artmer3061@gmail.com</strong></p>
                            <p className="text-neutral-cream/70 text-sm mt-1">처리 기간: 요청일로부터 최대 7일 이내</p>
                        </div>

                        <p className="mt-10 pt-6 border-t border-white/10 text-neutral-cream/60 text-sm">
