        ...
        <main className="min-h-screen bg-white text-neutral-900 pt-20 font-sans">
            ...
            <Container className="max-w-4xl py-12">
                <div className="space-y-16">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <h4 className="font-bold text-neutral-900 mb-2">1단계: 사진 촬영</h4>
                                        ...
                                        <div className="bg-neutral-50 p-4 rounded-lg border border-neutral-200">
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                <span className="text-sm font-medium text-neutral-700">참고 이미지 위치</span>
                                            </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <h4 className="font-bold text-neutral-900 mb-2">2단계: AI에게 질문하기</h4>
                                        <div className="bg-neutral-900 rounded-lg p-4 text-white font-mono text-sm">
                                            <div className="mb-2 text-neutral-400">AI 프롬프트 예시:</div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <h4 className="font-bold text-neutral-900 mb-2">3단계: AI 답변 확인</h4>
                    ...
                    {/* 실전 활용 팁 */}
                    <section className="space-y-6">
                        <h3 className="text-2xl font-bold text-neutral-900">실전 활용 팁</h3>
                        <div className="bg-neutral-50 border border-neutral-200 rounded-xl p-8">
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-neutral-900 mb-1">명확한 질문하기</h4>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-neutral-900 mb-1">관련 자료 함께 제공</h4>
                                        <p className="text-sm text-neutral-600">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-neutral-900 mb-1">단계별 확인</h4>
                                        <p className="text-sm text-neutral-600">
