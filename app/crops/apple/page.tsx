...
export const metadata: Metadata = {
  title: '사과 재배 | FarmSense',
  description: '팜센스 사과 서비스 준비 중입니다.',
};
  ...
  return (
    <main className="min-h-screen bg-neutral-black text-white pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">사과</h1>
        <p className="text-xl text-neutral-cream/70 mb-12">팜센스 사과 서비스는 현재 준비 중입니다.</p>
        ...
        <div className="p-8 bg-white/5 rounded-2xl border border-white/10 mb-16">
          <p className="text-neutral-cream/70 text-lg leading-relaxed">
            팜센스 사과 서비스는 현재 준비 중입니다. 포도 서비스를 먼저 이용해보세요.
          </p>
        </div>
