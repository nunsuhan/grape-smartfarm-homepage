            ...
            <div className="border-b border-neutral-200 bg-neutral-50/50">
                <Container className="max-w-3xl py-20">
                    <div className="space-y-6">
                        <div className="flex items-center gap-2 text-green-600 font-bold tracking-wide text-sm uppercase">
                        ...
                        <div className="flex items-center gap-1 bg-neutral-100 p-1 rounded-lg w-fit">
                            ...
                            <button
                                ...
                                className={clsx(
                                    "px-4 py-2 rounded-md text-sm font-medium transition-all",
                                    mode === 'technical' ? "bg-white text-green-600 shadow-sm border border-neutral-200" : "text-neutral-500 hover:text-neutral-900"
                                )}
                            >
                                상세 (Engineers)
                            </button>
                    ...
                    {mode === 'simple' ? (
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="bg-neutral-50 p-6 rounded-xl border border-neutral-200">
                                    <div className="text-green-600 font-bold mb-2 text-lg">1. 덩치를 키울 때 (초기)</div>
                                    <div className="text-neutral-900 text-3xl font-bold mb-1">30-10-10</div>
                                    <div className="text-sm text-neutral-600">질소(N) 비율을 높여 잎과 줄기를 만듭니다.</div>
                                </div>
                                <div className="bg-neutral-50 p-6 rounded-xl border border-neutral-200">
                                    <div className="text-purple-600 font-bold mb-2 text-lg">2. 맛을 들일 때 (후기)</div>
                                    <div className="text-neutral-900 text-3xl font-bold mb-1">14-14-30</div>
                                    <div className="text-sm text-neutral-600">칼륨(K) 비율을 높여 당도를 올립니다.</div>
                                </div>
                            </div>
                            ...
                            <div className="border border-neutral-200 rounded-xl p-6 bg-white">
                                ...
                                <div className="space-y-4">
                                    <div className="bg-green-50 border-l-4 border-green-500 pl-4 rounded">
                                        <p className="text-sm text-neutral-700">
                                            <strong>400 mg/L 고농도</strong> NPK(20:20:20) 처리 시 줄기 높이, 엽록소, 엽면적, 건조 중량이 유의미하게 증가합니다.
                                        </p>
                                    </div>
                                    <div className="bg-yellow-50 border-l-4 border-yellow-500 pl-4 rounded">
                                        <p className="text-sm text-neutral-700">
                        ...
                        >
                            <div className="space-y-8">
                                ...
                                {/* Data Table */}
                                <div className="bg-neutral-50 border border-neutral-200 rounded-lg overflow-x-auto">
                                    <table className="w-full text-sm text-left text-neutral-700 min-w-[600px]">
                                        <thead className="text-xs uppercase bg-neutral-100 text-neutral-600">
                                            <tr>
                                                ...
                                                <th className="px-6 py-3 text-neutral-900">Recommended NPK Ratio</th>
                                                <th className="px-6 py-3">Ref. Solution</th>
                                            </tr>
                                        </thead>
                                        <tbody className="divide-y divide-neutral-200">
                                            <tr className="hover:bg-white">
                                                <td className="px-6 py-4 font-medium text-neutral-900">L-29 (Fruit Set Start)</td>
                                                <td className="px-6 py-4">Vegetative Growth (Yield)</td>
                                                <td className="px-6 py-4 font-mono font-bold text-green-600">30 - 10 - 10</td>
                                                <td className="px-6 py-4">Peters 1 Type</td>
                                            </tr>
                                            <tr className="hover:bg-white">
                                                <td className="px-6 py-4 font-medium text-neutral-900">L-36 (Mid Veraison)</td>
                                                <td className="px-6 py-4">Sugar & Color Accumulation</td>
                                                <td className="px-6 py-4 font-mono font-bold text-purple-600">14 - 14 - 30</td>
                                ...
                                {/* 2. EC Safety Logic */}
                                <div className="bg-red-50 p-6 rounded-xl border border-red-300 relative overflow-hidden">
                                    ...
                                    <h3 className="text-lg font-bold text-neutral-900 mb-4 flex items-center gap-2">
                                        <AlertOctagon className="text-red-600 w-5 h-5" /> Safety Cut-off Threshold
                                    </h3>
                                    <div className="flex flex-col md:flex-row gap-6 items-center">
                                        <div className="text-center w-full md:w-auto">
                                            <div className="text-4xl font-bold text-neutral-900 mb-1">3.0 <span className="text-lg text-neutral-500">dS/m</span></div>
                                            <div className="text-xs text-neutral-600">Max Soil EC Limit</div>
                                        </div>
                                        <div className="flex-1 text-sm text-neutral-700 border-l border-neutral-300 pl-6 h-full flex items-center">
                                            <p>
                                                ...
                                                <span className="text-blue-600 font-bold"> 'Water Only'</span> mode to induce leaching.
                                            </p>
                                        </div>
                                    </div>
                                </div>
    ...
    return {
        ...
        "concentration": f"{target_ppm} mg/L"
                                ...
                                <div className="bg-white border border-neutral-200 rounded-xl p-6">
                                    <h3 className="text-xl font-bold text-neutral-900 mb-4">2. 영양 생장에 미치는 영향</h3>
                                    ...
                                    <h3 className="text-xl font-bold text-neutral-900 mb-4 mt-6">3. 수확량과 품질의 트레이드오프</h3>
                                    ...
                                    <h3 className="text-xl font-bold text-neutral-900 mb-4 mt-6">4. 분자 메커니즘 및 유전자 발현</h3>
                                    <div className="space-y-3 text-sm text-neutral-600">
                                    ...
                                    <h3 className="text-xl font-bold text-neutral-900 mb-4 mt-6">5. 다른 재배 요인과의 상호작용</h3>
                                ...
                                <div className="flex items-start gap-4 bg-neutral-50 p-4 rounded-lg border border-neutral-200">
                                    <BookOpen className="w-5 h-5 text-neutral-600 mt-1 shrink-0" />
                                    <div>
                                        <h4 className="text-neutral-900 font-bold text-sm">Scientific Basis</h4>
                                        <ul className="text-xs text-neutral-600 mt-2 space-y-1">
                                            <li>• <strong className="text-neutral-800">Concentration Source:</strong> <em>포도 재배를 위한 정밀 시비 알고리즘.pdf</em> Table 2 (400 mg/L efficacy)</li>
                                            <li>• <strong className="text-neutral-800">EC Limit Source:</strong> Background Soil Analysis Data (3.05 dS/m noted as high salinity)</li>
