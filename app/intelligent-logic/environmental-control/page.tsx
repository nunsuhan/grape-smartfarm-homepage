            ...
            <div className="border-b border-white/10 bg-white/5">
                <Container className="max-w-5xl py-20">
                    <div className="space-y-6">
                        <div className="flex items-center gap-2 text-indigo-400 font-bold tracking-wide text-sm uppercase">
                        ...
                        <div className="flex items-center gap-1 bg-white/10 p-1 rounded-lg w-fit">
                            ...
                            <button
                                ...
                                className={clsx(
                                    "px-4 py-2 rounded-md text-sm font-medium transition-all",
                                    mode === 'technical' ? "bg-indigo-500/20 text-indigo-300 shadow-sm border border-white/10" : "text-neutral-cream/60 hover:text-white"
                                )}
                            >
                                상세 (Engineers)
                            </button>
                    ...
                    {mode === 'simple' ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="bg-indigo-500/10 p-6 rounded-lg border border-indigo-500/20">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <h3 className="font-bold text-white">온도 제어</h3>
                                        </div>
                                    ...
                                    <div className="bg-yellow-500/10 p-6 rounded-lg border border-yellow-100">
                                        <div className="flex items-center gap-3 mb-3">
                                            <Sun className="w-6 h-6 text-yellow-600" />
                                            <h3 className="font-bold text-white">조도 제어</h3>
                                        </div>
                                        <p className="text-sm text-neutral-cream/70">
                        ...
                        >
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                ...
                                <div className="space-y-4">
                                    <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                                        <div className="text-xs font-bold text-neutral-cream/60 uppercase mb-2">Daytime Target</div>
                                        <div className="text-2xl font-bold text-white">25-28°C</div>
                                        <div className="text-xs text-neutral-cream/60 mt-1">Optimal for photosynthesis</div>
                                    </div>
                                    <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                                        <div className="text-xs font-bold text-neutral-cream/60 uppercase mb-2">Nighttime Target</div>
                                        <div className="text-2xl font-bold text-white">15-18°C</div>
                                        <div className="text-xs text-neutral-cream/60 mt-1">Respiration reduction</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                ...
                                <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                                    <div className="text-xs font-bold text-neutral-cream/60 uppercase mb-2">Target Range</div>
                                    <div className="text-2xl font-bold text-white">60-80% RH</div>
                                    <div className="text-xs text-neutral-cream/60 mt-1">Disease prevention threshold</div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                ...
                                <div className="bg-white/5 p-4 rounded-lg border border-white/10 mb-4">
                                    <div className="text-xs font-bold text-neutral-cream/60 uppercase mb-2">Daily Light Integral (DLI)</div>
                                    <div className="text-2xl font-bold text-white">12-16 mol/m²/day</div>
                                    <div className="text-xs text-neutral-cream/60 mt-1">Optimal for grape growth</div>
                                </div>
                                <CodeBlock
                                    language="python"
