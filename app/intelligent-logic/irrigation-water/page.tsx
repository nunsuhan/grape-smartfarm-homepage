...
export default function IrrigationWaterPage() {
                                ...
                                <div className="border border-white/10 rounded-xl p-6 bg-white/5">
                                    ...
                                    <div className="space-y-4">
                                        <div className="border-l-4 border-green-500 pl-4">
                                            <h5 className="font-semibold text-white mb-2">조절된 부족 관개 (RDI)</h5>
                                        ...
                                        <div className="border-l-4 border-blue-500 pl-4">
                                            <h5 className="font-semibold text-white mb-2">부분 뿌리 건조 (PRD)</h5>
                                            <p className="text-sm text-neutral-cream/70">
                                        ...
                                        <div className="border-l-4 border-purple-500 pl-4">
                                            <h5 className="font-semibold text-white mb-2">지속적 부족 관개 (SDI)</h5>
                                            <p className="text-sm text-neutral-cream/70">
    ...
    return {"action": "WAIT", "reason": "SUFFICIENT"}`}
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                <h3 className="text-xl font-bold text-white mb-4">물 관리 모니터링 및 스케줄링</h3>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                                            <div className="mb-3">
                                                <div className="text-sm font-semibold text-neutral-cream/80 mb-1">줄기 수분 포텐셜 (Ψ-stem)</div>
                                                ...
                                                <div className="bg-green-500/10 border-l-4 border-green-500 p-3 rounded">
                                                    <div className="text-lg font-bold text-green-400">-0.8 MPa 이상</div>
                                                    <div className="text-xs text-neutral-cream/70">수분 스트레스가 거의 없는 상태 (관개 기준값)</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                                            <div className="mb-3">
                                                <div className="text-sm font-semibold text-neutral-cream/80 mb-1">토양 수분 장력</div>
                                                <p className="text-sm text-neutral-cream/70 mb-2">
                                                    텐시오미터나 센서를 이용하여 토양 수분 장력을 측정하고 자동 관수 시스템을 구축할 수 있습니다.
                                                </p>
                                                <div className="bg-blue-500/10 border-l-4 border-blue-500 p-3 rounded">
                                                    <div className="text-lg font-bold text-blue-400">-60 kPa</div>
                                                    <div className="text-xs text-neutral-cream/70">샤인머스켓 시설 재배 관수 개시점 (물 사용량 39% 절약, 당도 우수)</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="bg-green-500/10 border-l-4 border-green-600 p-6 rounded-lg">
                                <h3 className="text-xl font-bold text-white mb-4">결론 및 제언</h3>
                                <p className="text-neutral-cream/80 mb-4 font-semibold">
                            ...
                            {/* 주요 관개 전략 상세 */}
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                <h3 className="text-xl font-bold text-white mb-4">3. 주요 관개 전략 (Irrigation Strategies)</h3>
                                
                                <div className="space-y-6">
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">3.1. 조절된 부족 관개 (Regulated Deficit Irrigation, RDI)</h4>
                                        <p className="text-sm text-neutral-cream/80 mb-3">
                                        ...
                                        <div className="bg-green-500/10 border-l-4 border-green-500 p-4 rounded">
                                            <p className="text-sm text-neutral-cream/80 mb-2"><strong>효과:</strong></p>
                                            <ul className="text-sm text-neutral-cream/70 space-y-1 list-disc list-inside">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">3.2. 부분 뿌리 건조 (Partial Root-zone Drying, PRD)</h4>
                                        <p className="text-sm text-neutral-cream/80 mb-3">
                                            PRD는 뿌리 영역의 반쪽은 관개하고 다른 반쪽은 건조하게 유지하며 주기적으로 그 위치를 바꾸는 방식입니다.
                                        </p>
                                        <div className="bg-blue-500/10 border-l-4 border-blue-500 p-4 rounded">
                                            <p className="text-sm text-neutral-cream/80 mb-2"><strong>메커니즘:</strong></p>
                                            <p className="text-sm text-neutral-cream/70 mb-2">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">3.3. 지속적 부족 관개 (Sustained Deficit Irrigation, SDI)</h4>
                                        <p className="text-sm text-neutral-cream/80 mb-3">
                            ...
                            {/* 관개 기술 상세 */}
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                <h3 className="text-xl font-bold text-white mb-4">4. 관개 기술 및 시스템</h3>
                                
                                <div className="space-y-4">
                                    <div>
                                        <h4 className="font-semibold text-white mb-2">4.1. 점적 관개 및 지중 점적 관개</h4>
                                        <div className="space-y-3">
                                            <div className="bg-white/5 p-4 rounded-lg">
                                                <p className="text-sm font-semibold text-neutral-cream/80 mb-1">표면 점적 관개(SD)</p>
                                                <p className="text-xs text-neutral-cream/70">가장 보편적이나 표면 증발 손실이 발생할 수 있습니다.</p>
                                            </div>
                                            <div className="bg-blue-500/10 p-4 rounded-lg border-l-4 border-blue-500">
                                                <p className="text-sm font-semibold text-neutral-cream/80 mb-1">지중 점적 관개(SDI)</p>
                                                <p className="text-xs text-neutral-cream/70 mb-2">
                                                    물을 뿌리 근처 지하로 직접 공급하여 증발을 줄이고 잡초 생장을 억제합니다. 
                                                    SD보다 물 사용 효율과 수확량이 더 높은 경향이 있습니다.
                                                </p>
                                            </div>
                                            <div className="bg-green-500/10 p-4 rounded-lg border-l-4 border-green-500">
                                                <p className="text-sm font-semibold text-neutral-cream/80 mb-1">직접 뿌리 영역 관개 (DRZ)</p>
                                                <p className="text-xs text-neutral-cream/70">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-white mb-2">4.2. 미세 살수 및 냉각 관개</h4>
                                        <p className="text-sm text-neutral-cream/70">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-white mb-2">4.3. 멀칭(Mulching) 활용</h4>
                                        <p className="text-sm text-neutral-cream/70">
                            ...
                            {/* 모니터링 및 스케줄링 상세 */}
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                <h3 className="text-xl font-bold text-white mb-4">5. 물 관리 모니터링 및 스케줄링</h3>
                                
                                <div className="space-y-6">
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">5.1. 식물 기반 지표 (Plant-based Indicators)</h4>
                                        <div className="bg-white/5 p-4 rounded-lg">
                                            <p className="text-sm font-semibold text-neutral-cream/80 mb-2">줄기 수분 포텐셜 (Ψ-stem)</p>
                                            <p className="text-xs text-neutral-cream/70 mb-3">
                                                포도나무의 수분 상태를 나타내는 가장 신뢰할 수 있는 지표로 간주됩니다.
                                            </p>
                                            <div className="bg-white/5 p-3 rounded border border-white/10">
                                                <p className="text-sm text-neutral-cream/80 mb-1"><strong>임계값:</strong></p>
                                                <ul className="text-xs text-neutral-cream/70 space-y-1 list-disc list-inside">
                                            ...
                                            <p className="text-xs text-neutral-cream/60 mt-3">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">5.2. 토양 기반 지표 (Soil-based Indicators)</h4>
                                        <div className="bg-white/5 p-4 rounded-lg">
                                            <p className="text-sm font-semibold text-neutral-cream/80 mb-2">토양 수분 장력</p>
                                            <p className="text-xs text-neutral-cream/70 mb-3">
                                                텐시오미터나 센서를 이용하여 토양 수분 장력을 측정하고 자동 관수 시스템을 구축할 수 있습니다.
                                            </p>
                                            <div className="bg-white/5 p-3 rounded border border-white/10">
                                                <p className="text-sm text-neutral-cream/80 mb-1"><strong>샤인머스켓 시설 재배 연구:</strong></p>
                                                <p className="text-xs text-neutral-cream/70">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">5.3. 원격 탐사 및 AI 기술</h4>
                                        <div className="bg-white/5 p-4 rounded-lg">
                                            <p className="text-sm font-semibold text-neutral-cream/80 mb-2">작물 수분 스트레스 지수 (CWSI)</p>
                                            <p className="text-xs text-neutral-cream/70 mb-3">
                                                열화상 카메라 등을 이용해 캐노피 온도를 측정하여 산출합니다. 
                                                저비용 적외선 센서 네트워크를 통해 Ψ-stem을 추정하고 관개 지도를 작성할 수 있습니다.
                                            </p>
                                            <p className="text-sm font-semibold text-neutral-cream/80 mb-2">의사 결정 지원 시스템 (DSS)</p>
                                            <p className="text-xs text-neutral-cream/70">
                            ...
                            {/* 결론 및 제언 */}
                            <div className="bg-green-500/10 border-l-4 border-green-600 p-6 rounded-lg">
                                <h3 className="text-xl font-bold text-white mb-4">7. 결론 및 제언</h3>
                                <p className="text-neutral-cream/80 mb-4 font-semibold">
                                    최신 연구들은 획일적인 물 공급에서 벗어나 <strong>데이터 기반의 정밀 관개</strong>로 전환할 것을 강력히 시사합니다.
                                </p>
                                <div className="space-y-3">
                                    <div className="bg-white/5 p-4 rounded border border-green-500/20">
                                        <p className="text-sm font-semibold text-white mb-2">1. 지표 활용</p>
                                        <p className="text-sm text-neutral-cream/70">
                                            Ψ-stem -0.8 MPa 또는 토양 수분 장력 -60 kPa와 같은 명확한 생리적/토양학적 임계값을 설정하여 자동화된 관개 시스템을 도입해야 합니다.
                                        </p>
                                    </div>
                                    <div className="bg-white/5 p-4 rounded border border-green-500/20">
                                        <p className="text-sm font-semibold text-white mb-2">2. 기술 도입</p>
                                        <p className="text-sm text-neutral-cream/70">
                                            물 부족 지역에서는 증발을 최소화하고 뿌리 발달을 돕는 지중 점적 관개(SDI)나 직접 뿌리 영역 관개(DRZ) 도입을 적극 고려해야 합니다.
                                        </p>
                                    </div>
                                    <div className="bg-white/5 p-4 rounded border border-green-500/20">
                                        <p className="text-sm font-semibold text-white mb-2">3. 품종 및 상황별 맞춤</p>
                                        <p className="text-sm text-neutral-cream/70">
                                    ...
                                    <div className="bg-white/5 p-4 rounded border border-green-500/20">
                                        <p className="text-sm font-semibold text-white mb-2">4. 기후 대응</p>
                                        <p className="text-sm text-neutral-cream/70">
