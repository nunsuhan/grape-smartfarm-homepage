                    ...
                    {mode === 'simple' ? (
                            ...
                            <div className="border border-white/10 rounded-xl p-6 bg-white/5 mb-8">
                                ...
                                <div className="space-y-4">
                                    <div className="border-l-4 border-blue-500 pl-4">
                                        <h5 className="font-semibold text-white mb-2">RGB-D 카메라</h5>
                                    ...
                                    <div className="border-l-4 border-green-500 pl-4">
                                        <h5 className="font-semibold text-white mb-2">분광 이미징</h5>
                                        <p className="text-sm text-neutral-cream/70">
                                    ...
                                    <div className="border-l-4 border-purple-500 pl-4">
                                        <h5 className="font-semibold text-white mb-2">스마트폰 기반 센싱</h5>
                                        <p className="text-sm text-neutral-cream/70">
                            ...
                            <div className="border border-white/10 rounded-xl p-6 bg-white/5">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="bg-blue-500/10 p-3 rounded-lg border border-blue-500/20">
                                        <div className="text-sm font-semibold text-white mb-1">환경 및 기후 요인</div>
                                        <div className="text-xs text-neutral-cream/70">
                                            가뭄, 폭염, 불규칙한 강우 등 이상 기후와 토양 수분, 온도, 꽃가루 농도 등을 반영합니다.
                                        </div>
                                    </div>
                                    <div className="bg-red-500/10 p-3 rounded-lg border border-red-500/20">
                                        <div className="text-sm font-semibold text-white mb-1">생리적 및 병리학적 요인</div>
                                        <div className="text-xs text-neutral-cream/70">
                        ...
                        >
                            <div className="prose prose-invert max-w-none">
                                ...
                                <div className="bg-yellow-500/10 border-l-4 border-yellow-500 p-4 rounded my-4">
...
def estimate_harvest_date(current_gdd):
    ...
    return estimate_days_remaining(TARGET_GDD - current_gdd)`}
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                <h3 className="text-xl font-bold text-white mb-4">3. 데이터 수집 기술의 진화 (Sensing Technologies)</h3>
                                
                                <div className="space-y-6">
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">3.1. 원격 및 근접 센싱</h4>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="bg-green-500/10 border-l-4 border-green-500 p-4 rounded">
                                                <h5 className="font-semibold text-white mb-2">분광 이미징 (Hyperspectral & Multispectral)</h5>
                                                <p className="text-sm text-neutral-cream/70 mb-2">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">3.2. 최적화된 샘플링 프로토콜</h4>
                                        <div className="bg-white/5 p-4 rounded-lg">
                                            <p className="text-sm text-neutral-cream/70">
                            ...
                            {/* AI 기반 예측 모델링 상세 */}
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                <h3 className="text-xl font-bold text-white mb-4">4. 인공지능(AI) 기반 예측 모델링</h3>
                                
                                <div className="space-y-6">
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">4.1. 머신러닝 (Machine Learning)</h4>
                                        <div className="bg-white/5 p-4 rounded-lg">
                                            <p className="text-sm font-semibold text-neutral-cream/80 mb-2">알고리즘:</p>
                                            <ul className="text-sm text-neutral-cream/70 space-y-1 list-disc list-inside mb-3">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">4.2. 딥러닝 (Deep Learning)</h4>
                                        <div className="space-y-3">
                                            <div className="bg-blue-500/10 border-l-4 border-blue-500 p-4 rounded">
                                                <h5 className="font-semibold text-white mb-2">컴퓨터 비전 (CNN)</h5>
                                                <p className="text-sm text-neutral-cream/70">
                                            ...
                                            <div className="bg-green-500/10 border-l-4 border-green-500 p-4 rounded">
                                                <h5 className="font-semibold text-white mb-2">시계열 분석 (RNN/LSTM)</h5>
                                                <p className="text-sm text-neutral-cream/70">
                                            ...
                                            <div className="bg-purple-500/10 border-l-4 border-purple-500 p-4 rounded">
                                                <h5 className="font-semibold text-white mb-2">앙상블 학습 (Ensemble Learning)</h5>
                                                <p className="text-sm text-neutral-cream/70">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">4.3. 설명 가능한 AI (XAI)</h4>
                            ...
                            {/* 수확량 예측의 핵심 변수 상세 */}
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                <h3 className="text-xl font-bold text-white mb-4">5. 수확량 예측의 핵심 변수 및 고려 사항</h3>
                                
                                <div className="space-y-6">
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">5.1. 수확량 구성 요소 (Yield Components)</h4>
                                        <div className="bg-white/5 p-4 rounded-lg">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">5.2. 환경 및 기후 요인</h4>
                                        <div className="space-y-3">
                                            <div className="bg-red-500/10 border-l-4 border-red-500 p-4 rounded">
                                                <h5 className="font-semibold text-white mb-2">이상 기후</h5>
                                                <p className="text-sm text-neutral-cream/70">
                                            ...
                                            <div className="bg-blue-500/10 border-l-4 border-blue-500 p-4 rounded">
                                                <h5 className="font-semibold text-white mb-2">꽃가루(Pollen)</h5>
                                                <p className="text-sm text-neutral-cream/70">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-white mb-3">5.3. 생리적 및 병리학적 요인</h4>
                                        <div className="space-y-3">
                                            <div className="bg-orange-500/10 border-l-4 border-orange-500 p-4 rounded">
                                                <h5 className="font-semibold text-white mb-2">질병</h5>
                                                <p className="text-sm text-neutral-cream/70">
                                            ...
                                            <div className="bg-purple-500/10 border-l-4 border-purple-500 p-4 rounded">
                                                <h5 className="font-semibold text-white mb-2">영양 스트레스</h5>
                                                <p className="text-sm text-neutral-cream/70">
                            ...
                            <div className="bg-green-500/10 border-l-4 border-green-600 p-6 rounded-lg">
                                <h3 className="text-xl font-bold text-white mb-4">6. 결론 및 향후 전망</h3>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="bg-white/5 p-4 rounded border border-green-500/20">
                                        <p className="text-sm font-semibold text-white mb-2">엣지 컴퓨팅(Edge Computing)</p>
                                        <p className="text-sm text-neutral-cream/70">
                                            통신이 원활하지 않은 농장 환경에서도 실시간 처리가 가능하도록 트랙터나 드론에 탑재된 소형 장치에서 경량화된 AI 모델을 구동하는 기술이 발전하고 있습니다.
                                        </p>
                                    </div>
                                    <div className="bg-white/5 p-4 rounded border border-green-500/20">
                                        <p className="text-sm font-semibold text-white mb-2">통합 모델링</p>
                                        <p className="text-sm text-neutral-cream/70">
                                ...
                                <p className="text-sm text-neutral-cream/80 mt-4 italic">
