                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <motion.div
                                ...
                                className="bg-neutral-black border border-white/10 p-8 rounded-xl hover:border-secondary-gold/30 transition-colors group"
                            >
                                <item.icon className="w-10 h-10 text-secondary-gold mb-6 group-hover:scale-110 transition-transform" />
