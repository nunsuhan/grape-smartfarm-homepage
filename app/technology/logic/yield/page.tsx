                            ...
                            <div className="border border-neutral-200 rounded-xl p-8 bg-white shadow-sm">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div className="bg-neutral-50 p-4 rounded-lg border border-neutral-100 text-center">
                                        ...
                                        <div className="font-bold text-neutral-900">1. 찰칵! 송이 세기</div>
                                        <div className="text-xs text-neutral-500 mt-1">AI 자동 카운팅</div>
                                    </div>
                                    <div className="bg-neutral-50 p-4 rounded-lg border border-neutral-100 text-center">
                                        <Sun className="w-8 h-8 mx-auto text-yellow-500 mb-2" />
                                        <div className="font-bold text-neutral-900">2. 햇빛 계산</div>
                                        <div className="text-xs text-neutral-500 mt-1">적산온도 누적</div>
                                    </div>
                                    <div className="bg-neutral-50 p-4 rounded-lg border border-neutral-100 text-center">
                                        <Sprout className="w-8 h-8 mx-auto text-green-500 mb-2" />
                                        <div className="font-bold text-neutral-900">3. 과거 비교</div>
                                        <div className="text-xs text-neutral-500 mt-1">작년 데이터 분석</div>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
