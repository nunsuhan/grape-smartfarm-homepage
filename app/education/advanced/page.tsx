        ...
        <main className="min-h-screen bg-neutral-black text-neutral-cream pt-20 font-sans">
            <Section className="py-20 bg-white/5 border-b border-white/10">
                <Container className="max-w-5xl">
                    ...
                    <p className="text-neutral-cream/70 mt-4 text-lg leading-relaxed">
                ...
                <Container className="max-w-5xl">
                    <div className="space-y-12">
                        ...
                        <div className="bg-white/5 border border-white/10 p-8 rounded-2xl shadow-sm">
                            ...
                            <p className="text-neutral-cream/70 mb-6 font-light leading-relaxed">
...
def read_soil_sensor(port='/dev/ttyUSB0'):
    ...
    return None`}
                        ...
                        {/* Link to API */}
                        <div className="bg-white/5 p-6 rounded-xl border border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
                            <div>
                                <h3 className="text-white font-bold text-lg mb-1">데이터 전송 준비가 되셨나요?</h3>
                                <p className="text-sm text-neutral-cream/60">수집한 데이터를 FarmSense 클라우드로 보내는 방법을 확인하세요.</p>
                            </div>
