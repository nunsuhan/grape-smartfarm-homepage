            ...
            <Container className="max-w-3xl py-12">
                <div className="space-y-12">
                    ...
                    <div className="bg-white border border-neutral-200 rounded-2xl shadow-sm overflow-hidden">
                        <div className="p-1 bg-neutral-100 border-b border-neutral-200">
                        ...
                        <div className="p-6 md:p-8">
                            ...
                            <div className="mt-6 flex flex-col md:flex-row gap-4 justify-between items-center">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="font-bold text-neutral-900">강의 자료 PDF</div>
                                        <div className="text-xs text-neutral-500">회로도 및 라이브러리 가이드 (v1.2)</div>
                                    </div>
                                </div>
